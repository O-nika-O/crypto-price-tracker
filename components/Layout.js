...
const Layout = ({ children, title = "Crypto Tracker" }) => {
                ...
                <Link href="/" passHref>
                    <a>
                        ...
                        >
                            <path
                                style={{fill:"#FFF48B"}}
                                d="M470.145,256.001c0,118.269-95.875,214.144-214.144,214.144S41.858,374.27,41.858,256.001
	S137.734,41.858,256.001,41.858S470.145,137.734,470.145,256.001z"
                            />
                            <path
                                style={{fill:"#EA7C18"}}
                                d="M512.001,256.001c0,6.147-4.983,11.13-11.13,11.13h-63.746
	...
	l-63.623,63.623c26.049,29.427,42.705,67.341,45.24,109.013h63.745C507.018,244.871,512.001,249.854,512.001,256.001z"
                            ...
                            <path
                                style={{fill:"#EDB311"}}
                                d="M411.827,256.001c0,86.061-69.766,155.826-155.826,155.826s-155.826-69.766-155.826-155.826
	s69.766-155.826,155.826-155.826S411.827,169.941,411.827,256.001z"
                            />
                            <path
                                style={{fill:"#F7DB4F"}}
                                d="M367.306,256.001c0,61.471-49.833,111.304-111.304,111.304s-111.304-49.833-111.304-111.304
	s49.833-111.304,111.304-111.304S367.306,194.53,367.306,256.001z"
                            />
                            <path
                                style={{fill:"#FF4800"}}
                                d="M244.871,149.536c0-6.147,4.983-11.13,11.13-11.13c3.917,0,7.868,0.195,11.747,0.58
	...
	c64.843,0,117.595-52.754,117.595-117.595C373.598,218.663,356.454,184.374,326.566,161.922z"
                            ...
                            <path
                                style={{fill:"#EDB311"}}
                                d="M3.261,19.003c-4.346-4.346-4.346-11.394,0-15.742s11.394-4.346,15.742,0L29.652,13.91
